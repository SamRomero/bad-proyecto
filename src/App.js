...
import ExamsOrder from './components/pages/ExamsOrder/ExamsOrder';
import Muestra from './components/pages/Muestra/Muestra';
    ...
    <div className="App">
      {
        ...
        <Router>
          ...
          <Routes>
            ...
            <Route path='/exams-order' element={<ExamsOrder/>} />
